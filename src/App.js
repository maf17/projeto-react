...
import { getAllContatos, criarContatos, editarContato, deletarContato } from './components/Api'
      ...
      <>    
        <nav className="navbar navbar-dark bg-dark">
          <div className="container-fluid">
            <h1 style={{ 
              color: "white",
              fontSize: "30px" }} className="navbar-brand">
              Projeto React</h1>
            <Form>
            <FormGroup className="mb-2 mr-sm-2 mb-sm-0">
              ...
              <div>
                <input className="form-control me-2" onChange={this.filtrar} type="search" placeholder="Buscar" aria-label="Search"></input>
              </div> 
            </FormGroup>
            </Form>
            </div>
